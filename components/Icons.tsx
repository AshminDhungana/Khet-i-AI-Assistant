...
export const Droplet = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M12 2.69l5.74 5.74c.82.82 1.3 1.96 1.3 3.16 0 2.47-2 4.47-4.47 4.47S10.13 14.06 10.13 11.6c0-1.2.48-2.34 1.3-3.16L12 2.69z" />
  </svg>
);
